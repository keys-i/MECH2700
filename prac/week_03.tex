...
\section*{Question 1.}
    ...
    \[
    (x_0,v_0)=(1.5,6.23),\quad
    (x_1,v_1)=(1.65,7.09),\quad
    (x_2,v_2)=(1.95,8.97)
    \]
    ...
    \[
        v[x_0,x_1]
        = \frac{7.09-6.23}{1.65-1.5}
        = 5.733333
    \]
    and
    \[
        v[x_1,x_2]
        = \frac{8.97-7.09}{1.95-1.65}
        = 6.266667
    \]
    ...
    \[
        ...
        = 6.23
        + 5.733333(x-1.5)
        + 1.185185(x-1.5)(x-1.65)
    \]
    Expanding:
    \[
        v(x)
        = 1.185185x^2+2x+0.563333
    \]
    ...
    \end{aligned}
    \]
    Because the interpolant is quadratic, the second derivative is constant. Therefore, at $x=1.8\,\text{m}$,
...
\begin{solution}
	...
	\[
    	M=-21\ \text{kN}\cdot\text{m}
    	=-21\,000\ \text{N}\cdot\text{m}
	\]
	and
	\[
    	I=18.5\times10^6\ \text{mm}^4.
    \]
	Since
	\[
	...
	\[
    	I
    	= 18.5\times10^6\times10^{-12}
    	= 1.85\times10^{-5}\ \text{m}^4
	\]

	Substitute into the equation:
	\[
        E
    	= -\frac{-21\,000}{(1.85\times10^{-5})(2.37037\times10^{-3})}
	\]
	Therefore,
	\[
	    E=4.78885\times10^{11}\ \text{Pa}
	\]
